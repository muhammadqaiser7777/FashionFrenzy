...
from middleware.authToken import generate_temp_token_retailer as generate_temp_token
from datetime import datetime, timedelta
import re

def retailerChangePassword():
